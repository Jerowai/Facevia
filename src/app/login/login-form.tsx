    ...
    <div className="flex flex-col items-center">
      ...
      <div className="w-full space-y-4 mt-4">
        ...
        <div className="w-full flex items-center gap-3">
          ...
          <span className="text-xs text-gray-500 font-medium">{t('auth.or')}</span>
          <div className="flex-1 h-px bg-white/10" />
        </div>

        <form onSubmit={handleSubmit} className="w-full space-y-4">
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-gray-300" htmlFor="login-email">{t('auth.email')}</label>
            <input
              id="login-email"
              type="email"
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-gray-300" htmlFor="login-password">{t('auth.password')}</label>
          ...
          >
            {loading ? <><Loader2 className="w-5 h-5 animate-spin" /> {t('auth.login.signingIn')}</> : t('auth.login.submit')}
          </button>
        </form>
      </div>
    </div>
