    ...
    <section id="photos" className="py-24 px-6 bg-[#0F172A]">
      <div className="container max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Built for <span className="text-gradient">high-quality matches</span>
          </motion.h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Our AI generates photos that look completely natural. No more awkward selfies or blurry shots.
          </p>
        </div>
          ...
          {EXAMPLE_IMAGES.map((src, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                <span className="text-white text-xs font-semibold px-2 py-1 rounded bg-white/10 backdrop-blur-md">
                   AI Generated
                </span>
              </div>
