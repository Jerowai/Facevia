  ...
  const PLANS = [
    {
      ...
      price: "$9",
      label: "/one-time",
      description: "Perfect to get started with AI dating photos.",
      features: [
        "20 AI Photos",
        "5 style presets",
    ...
    },
    {
      ...
      price: "$19",
      label: "/one-time",
      description: "Most popular — the best value for dating apps.",
      features: [
        "60 AI Photos",
        "15 style presets",
        "Faster generation",
    ...
    },
    {
      ...
      price: "$29",
      label: "/one-time",
      description: "For serious daters who want the best results.",
      features: [
        "120 AI Photos",
        "All style presets",
        "Fastest generation",
